...
module Homebrew
  ...
  class UnversionedCaskChecker
    ...
    def apps
      @apps ||= T.let(@cask.artifacts.select { |a| a.is_a?(Cask::Artifact::App) }, T.nilable(T::Array[Cask::Artifact::App]))
    end

    sig { returns(T::Array[Cask::Artifact::KeyboardLayout]) }
    def keyboard_layouts
      @keyboard_layouts ||= T.let(@cask.artifacts.select { |a| a.is_a?(Cask::Artifact::KeyboardLayout) }, T.nilable(T::Array[Cask::Artifact::KeyboardLayout]))
    end

    sig { returns(T::Array[Cask::Artifact::Qlplugin]) }
    def qlplugins
      @qlplugins ||= T.let(@cask.artifacts.select { |a| a.is_a?(Cask::Artifact::Qlplugin) }, T.nilable(T::Array[Cask::Artifact::Qlplugin]))
    end

    sig { returns(T::Array[Cask::Artifact::Dictionary]) }
    def dictionaries
      @dictionaries ||= T.let(@cask.artifacts.select { |a| a.is_a?(Cask::Artifact::Dictionary) }, T.nilable(T::Array[Cask::Artifact::Dictionary]))
    end

    sig { returns(T::Array[Cask::Artifact::ScreenSaver]) }
    def screen_savers
      @screen_savers ||= T.let(@cask.artifacts.select { |a| a.is_a?(Cask::Artifact::ScreenSaver) }, T.nilable(T::Array[Cask::Artifact::ScreenSaver]))
    end

    sig { returns(T::Array[Cask::Artifact::Colorpicker]) }
    def colorpickers
      @colorpickers ||= T.let(@cask.artifacts.select { |a| a.is_a?(Cask::Artifact::Colorpicker) }, T.nilable(T::Array[Cask::Artifact::Colorpicker]))
    end

    sig { returns(T::Array[Cask::Artifact::Mdimporter]) }
    def mdimporters
      @mdimporters ||= T.let(@cask.artifacts.select { |a| a.is_a?(Cask::Artifact::Mdimporter) }, T.nilable(T::Array[Cask::Artifact::Mdimporter]))
    end

    sig { returns(T::Array[Cask::Artifact::Installer]) }
    def installers
      @installers ||= T.let(@cask.artifacts.select { |a| a.is_a?(Cask::Artifact::Installer) }, T.nilable(T::Array[Cask::Artifact::Installer]))
    end

    sig { returns(T::Array[Cask::Artifact::Pkg]) }
    def pkgs
      @pkgs ||= T.let(@cask.artifacts.select { |a| a.is_a?(Cask::Artifact::Pkg) }, T.nilable(T::Array[Cask::Artifact::Pkg]))
    end
